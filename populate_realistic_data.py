...
def populate_policies_claims_premiums():
    ...
    while retry_count < max_retries:
        try:
            ...
            required_tables = ['clients', 'risks', 'policies', 'premiums', 'claims']
            missing_tables = []
            ...
            if missing_tables:
                print(f"Tabelle mancanti: {missing_tables}. Attendo che lo schema venga applicato...")
                conn.close()
                retry_count += 1
                time.sleep(2)
                continue
    ...
    print(f"Impossibile popolare i dati dopo {max_retries} tentativi")
    return
